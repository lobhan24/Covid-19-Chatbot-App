...
public class ChatRVdapter extends RecyclerView.Adapter{
    private ArrayList<ChatsModel> chatsModelArrayList;
    private Context context;

    public ChatRVdapter(ArrayList<ChatsModel> chatsModelArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ChatsModel chatsModal = chatsModelArrayList.get(position);
